...
Contains application source code. Expo will first run App.js. App.js links with
Main.js inside assets folder.
...
Contains screens of app. You can create sub container components in related screens.


### assets/screens/{screenName}Screen.js
...
Contains redux actions. Actions names must links with type.js. And export every action
functions through index.js
